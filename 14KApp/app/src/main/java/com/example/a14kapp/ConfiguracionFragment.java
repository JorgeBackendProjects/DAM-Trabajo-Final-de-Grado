...
public class ConfiguracionFragment extends Fragment {
    ...
    private Button datos, password;

    public ConfiguracionFragment(String email) {
        this.email = email;
    }
    ...
    public static ConfiguracionFragment newInstance(String param1, String param2) {
        ConfiguracionFragment fragment = new ConfiguracionFragment(email);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        datos = view.findViewById(R.id.boton_modificar_datos);
        datos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), ModificarDatos.class);
                intent.putExtra("Email", email);
                startActivity(intent);
            }
        });

        password = view.findViewById(R.id.boton_cambiar_password);
